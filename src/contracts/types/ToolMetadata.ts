...
export const TOOL_METADATA: Readonly<Record<string, ToolMetadata>> = Object.freeze({
  ...
  add_subsystem: write('workflow', { visibility: 'leader', dangerous: false, resultShape: 'json' }),
  update_subsystem: write('workflow', { visibility: 'leader', dangerous: false, resultShape: 'json' }),
  delete_subsystem: write('workflow', { visibility: 'leader', dangerous: false, resultShape: 'json' }),
  canvas_save_sourcemap: write('session', { visibility: 'leader', dangerous: false, resultShape: 'json' }),
  canvas_push_version: write('session', { visibility: 'leader', dangerous: false, resultShape: 'json' }),
  canvas_get_state: read('session', { visibility: 'leader', resultShape: 'json' }),

...
/**
 * Kitty keyboard protocol scroll wheel keycodes.
 * When kitty protocol is enabled, wheel events arrive as keyboard events
 * (CSI-u keycodes 57359/57360) rather than mouse events.
 */
export const KITTY_KEYCODE_WHEEL_UP = 57359;
export const KITTY_KEYCODE_WHEEL_DOWN = 57360;

...
以下项目均由凌霄 AI 研发平台自主生成——从架构设计到全栈实现、测试验证，全程 AI-driven，人工仅提供需求与方向。

| 项目 | 简介 | 技术栈 |
|---|---|---|
| [凌霄·渡劫](https://github.com/hexian2001/lingxiao-tribulation) | LLM 驱动全自主渗透测试平台 · 赛博修仙美学 · DAG + Blackboard + Plan&Execute | FastAPI · Next.js 14 · WebSocket |
| [墨澜 Ink-Flow](https://github.com/hexian2001/ink-flow) | 多 Agent 协同长篇小说创作平台 · 水墨鎏金设计语言 · React 18 + Express | Express · React 18 · WebSocket · SSE |

![凌霄·渡劫 — DAG 攻击树可视化](https://raw.githubusercontent.com/hexian2001/lingxiao-tribulation/main/images/06-dag-live.png)

![墨澜 Ink-Flow — Agent 实时监控大屏](https://raw.githubusercontent.com/hexian2001/ink-flow/main/images/04-agent-monitor.png)
